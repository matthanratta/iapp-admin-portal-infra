...
# Paramters
# $1 = The build number
# $2 = The name of the template file to build located in the build directory, (e.g.: iapp-portal2-infra.yaml)
...
#
# Parameters
# $1 = The name of the template file, (e.g.: iapp-portal2-infra.yaml)
...
# $2 = The name of the template file, (e.g.: iapp-portal2-infra.yaml)
# $3 = The release the artifact is related with, (e.g.: 0.1.19)
